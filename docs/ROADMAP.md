...
| **R01b** | — | **Curadoria 50 golden queries** (cognitive floor, não comprime) — **25/50 cured 2026-05-02** (5 seed + 20 batch1: 17 com chunks + 3 negative cases identificados); restante 25 queries | 🔄 IN-PROGRESS (25/50) | **8-10** (humano) | spread Jun-Jul |
| **R01c** | — | Baseline FTS-only vs hybrid run + publish nDCG@10 em `/api/eval-metrics` — **n=25 cured: hybrid nDCG@10=0.714 / MRR=0.683 / Recall@10=0.840** (decision queries 0.980, entity 0.509 ponto fraco, concept 0.888, negative=0 OK specificity); FTS-only n=5 = 0.000 (AND-strict). Trigger D01 (≥0.6) persiste em sample maior | 🔄 IN-PROGRESS (n=25) | 1-2 | R01a ✅ + R01b 50q completo |
