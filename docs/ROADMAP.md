...
| **Wave B Composability matrix** *(NEW PRIORITY)* | KG+MQ additive bench (predicted +6.42pp F_MH = 41% MemOS gap closure) + KG+MAP corpus-aware MA recovery + triple combo stretch | **🟢 In-flight** | Validates additivity hypothesis. Major paper §5 narrative shift if holds. |
