...
> **D01-v1 cross-encoder reranker ⛔ CUT** 2026-05-08 12:20 BRT (commit `068dd29`). Offline eval com `NOX_RERANKER_MODE=active` 3-run sobre R01c-v1.1 (n=65) retornou nDCG 0.3718 vs hybrid 0.5831 → **Δ = -0.2113**. BGE-reranker-base inglês não transfere PT-BR domain. Lição: shadow lift_score=0.341 era enganosa — sempre validar via offline nDCG antes de promover. **D01-v2 multilingual reranker (BGE-v2-m3 ou Cohere)** deferred future work.
