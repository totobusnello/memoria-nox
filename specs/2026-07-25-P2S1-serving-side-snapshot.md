...
- [x] **T2b** ✅ **MERGED 2026-07-25** — `brief_id TEXT` no `brief_log` + migração idempotente ([nox-workspace#27](https://github.com/totobusnello/nox-workspace/pull/27)). Falta `git pull` + rebuild + restart do `nox-mem-api` na VPS; a migração roda sozinha na primeira requisição (`ensureBriefLog`).
