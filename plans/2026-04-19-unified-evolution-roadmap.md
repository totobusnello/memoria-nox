...
| 2 | Graphify + GitHub repos | 🔧 IN PROGRESS (7/~15 repos, 2026-04-23) | escalando | IM + 1.7b-a | 7 repos ingestados: sao-thiago-fii (94), projeto-ai-galapagos (147), Granix-App (163), daily-tech-digest (112), nox-supermem (56), agent-hub-dashboard (240), memoria-nox (50) = 862 graph_node chunks, todos retention=60d. Hybrid search mistura code+docs+rationale. Tier 1 comerciais (Future-Farm, GalapagosApp, Frooty, Superfrio, GranCoffee, BIolab-AI, Curso-AI, Fake-News-Check) + Tier 2 áreas (Area-Manuel_Nobrega, Area-Campolim-Sorocaba) pendentes — graphify update local + scp + ingest via `node dist/graphify-ingest.js <graph.json> <repo-name>` |
