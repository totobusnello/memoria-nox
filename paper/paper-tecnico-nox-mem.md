...
**Technical report — v1.0.1 (arXiv preprint)**

**Paper version:** v1.0.1 (2026-07-12) — post-submit honesty residual (S1/S3), staged for arXiv replacement; changelog in `paper/CHANGELOG.md`
