...
Zep + Postgres/pgvector) ran the **full canonical set, n = 2,482, zero errors**, in 4 h 13 min.
...
widest per-dataset spread here. Its p50 of 6,002 ms is **9.2×** nox-mem's 653 ms and **3.8×**
EverOS's 1,592 ms; the p99 is 11,846 ms.
