...
O resultado é que uma lição de prod-outage de seis meses atrás supera uma documentação atualizada ontem sobre assunto menor. Exatamente como a memória humana funciona. O sistema agora tem 64.180+ chunks com essa dimensão ativa, validada por 7 dias de telemetria real.
