...
\begin{tabular}{llll}
    ...
    \midrule
    entity      & TBD & TBD & \textsc{[Pending: per-category breakdown W2]} \\
...
\begin{tabular}{lllll}
    ...
    \midrule
    concept     & 15 & 0.2393 & \textsc{[Pending: W2]} & --- \\
    decision    & 6  & 0.2062 & --- & --- \\
    security    & 6  & 0.1597 & --- & --- \\
    entity      & 11 & 0.1357 & --- & --- \\
    procedure   & 13 & 0.1053 & --- & --- \\
...
\begin{tabular}{lll}
    ...
    nox-mem vs E5-mistral-7b-instruct & $\geq 0$\,pp & \textsc{[Pending: W2]} \\
    \bottomrule
  \end{tabular}}
\end{table}
...
\begin{tabular}{llll}
  ...
  \begin{minipage}{\linewidth}
    ...
    are pending. Controlled via: \texttt{NOX\_RRF\_DISABLE=1},
