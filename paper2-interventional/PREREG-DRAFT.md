...
5. `sig()` taxonomy + frozen pipeline commit + synthetic-input PAP hash. **Unblocked 2026-07-26:** the engineering track (P2S1) is closed, so the pipeline can now be frozen without freezing something still in flight.
