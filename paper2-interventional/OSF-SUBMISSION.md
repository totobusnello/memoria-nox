...
| Arquivo | Onde | Nota |
|---|---|---|
| `PREREG-v1.10-2026-08-17.pdf` | scratchpad da sessão (1,8 MB, 75 pp) | **Anexo principal.** Emoji e símbolos convertidos para ASCII; gerado via Chrome headless a partir do HTML (a instalação LaTeX local está incompleta). Números travados conferidos no texto extraído |
| `PREREG-v1.10-2026-08-17.html` | scratchpad (263 KB) | Preserva tabelas e formatação melhor que o PDF; anexar como secundário se o OSF aceitar |
