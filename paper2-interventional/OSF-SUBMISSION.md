...
| Arquivo | Onde | Nota |
|---|---|---|
| `PREREG-v1.7-2026-08-16.pdf` | scratchpad da sessão (1,1 MB, 49 pp) | **Anexo principal.** Emoji e símbolos convertidos para ASCII; gerado via Chrome headless a partir do HTML (a instalação LaTeX local está incompleta). Números travados conferidos no texto extraído |
| `PREREG-v1.7-2026-08-16.html` | scratchpad (192 KB) | Preserva tabelas e formatação melhor que o PDF; anexar como secundário se o OSF aceitar |
